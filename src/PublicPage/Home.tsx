      ...
      <div className="w-full px-6 py-16 mx-auto max-w-7xl sm:px-6 sm:py-24 lg:px-8 lg:py-32">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-extrabold text-black sm:text-5xl">
            ...
            <strong className="px-2 text-black rounded-md">boost team productivity</strong>
          </h1>

          <p className="mt-6 text-lg text-black sm:text-xl sm:leading-relaxed">
            A powerful task management system that helps you organize projects, assign tasks,
            follow progress, and collaborate with your team — all in one sleek dashboard.
          </p>
          ...
          <div className="flex justify-center gap-6 mt-10 sm:mt-12">
            ...
            >
              ...
              <span className="relative z-10">Start Managing Tasks</span>
            </button>
